...
def main() -> None:
    ...
    check(client.get("/api/documents/", params={"company_id": COMPANY_ID}), "list documents")
    ...
    chat_resp = client.post(
        "/api/chat",
        json={
            "question": "Какова столица Казахстана и сколько там жителей?",
    ...
    check(
        client.get("/api/chat/history", params={"company_id": COMPANY_ID}),
        "chat history",
    )
