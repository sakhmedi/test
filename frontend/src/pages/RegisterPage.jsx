  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm text-center mb-8">{t('registerCompany')}</p>
        ...
        >
          ...
          <div>
            <label className="block text-gray-700 dark:text-gray-300 text-sm font-medium mb-1">{t('companyName')}</label>
            <input
              type="text"
              required
              value={companyName}
