  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <h1 className="text-2xl font-bold text-white mb-1 text-center">Create your workspace</h1>
        <p className="text-slate-400 text-sm text-center mb-8">Register your company on DocuFlow AI</p>
